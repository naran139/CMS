...
urlpatterns = [
    ...
    path('staff/give/assignment/', staff_views.give_assignment,
         name='give_assignment'),
    path('staff/manage/assignment/',staff_views.manage_assignment,
          name='manage_assignment'),
    path('remove/submission/', staff_views.remove_submission,
          name='remove_submission'),
     path('submitted_assignments/', staff_views.submitted_assignments,
    ...
    path('student/submit/assignment/<int:assignment_id>/',student_views.student_submit_assignment,
          name='student_submit_assignment'),
    path("student/result/<int:course_id>",hod_views.get_result,
          name="get_result"),
     path('result/',hod_views.result,name="result"),
     path('sort_results/', hod_views.sort_results, 
          name='sort_results'),
